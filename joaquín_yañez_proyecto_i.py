...
display(Image('https://graffica.info/wp-content/uploads/2017/07/logo-nasa-fondo-oscuro.jpg'))
...
#Creamos el lienzo
img = Image.new('RGBA', (250,250), (255,255,255,1))
#Creamos el polígono
...
"""Implementación de prototipos de funciones:
...
def mutation(population: list) -> list:
  """ Operador que toma una población y muta alguna característica de sus individuos

      Args:
      population: list

      Returns:
      Una lista que representa la nueva población
  """
...
print(mutation(crear_poblacion(3)))